CREATE TABLE restaurant_orders
	(city VARCHAR(50), restaurant_id INT, order_id INT, order_date DATE);
INSERT INTO 
restaurant_orders (city, restaurant_id, order_id, order_date)
	VALUES
...
SELECT city,
       COUNT(*) AS highest_number_of_orders
...
SELECT city, COUNT(order_id) as total_orders FROM restaurant_orders WHERE city IN ('Delhi', 'Mumbai', 'Bangalore', 'Hyderabad') AND order_date BETWEEN '2021-09-01' AND '2021-09-30' GROUP BY city ORDER BY total_orders DESC LIMIT 1;
